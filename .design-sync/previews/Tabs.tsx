...
import { Tab, TabList, TabPanel, Tabs } from "preskok"
...
export function Horizontal() {
  return (
    <Tabs aria-label="Workspace settings" className="w-full">
      ...
      <TabPanel id="alerts">Notification rules are managed by admins.</TabPanel>
    </Tabs>
  )
}
...
export function Vertical() {
  return (
    <Tabs aria-label="Deployment details" orientation="vertical" className="min-h-40">
      <TabList>
        <Tab id="activity">
