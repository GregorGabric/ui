...
description: Install and configure Preskok UI for TanStack Start.
---
...
Start by creating a new TanStack Start project by following the [Build a Project from Scratch](https://tanstack.com/start/latest/framework/react/build-from-scratch) guide on the TanStack Start website.
