  ...
  return (
    <Menu>
      ...
      <MenuContent placement="bottom end">
        <MenuItem onAction={() => setThemeState("theme-light")}>Light</MenuItem>
        <MenuItem onAction={() => setThemeState("dark")}>Dark</MenuItem>
        <MenuItem onAction={() => setThemeState("system")}>System</MenuItem>
      </MenuContent>
    </Menu>
  )
}
