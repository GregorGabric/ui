    ...
    <span data-slot="control" className="relative block w-full">
      <Button
        className={cx(
          ...
          "group-open/select:invalid:border-destructive-foreground/70 group-open/select:invalid:bg-destructive/5 group-open/select:invalid:ring-destructive-foreground/20 group-invalid/select:border-destructive-foreground/70 group-invalid/select:bg-destructive/5 group-invalid/select:ring-destructive-foreground/20 group-invalid/select:enabled:hover:border-destructive-foreground/80 group-focus/select:group-invalid/select:border-destructive-foreground/70 group-focus/select:group-invalid/select:ring-destructive-foreground/20 group-focus/select:group-invalid/select:enabled:hover:border-destructive-foreground/80 group-open/select:invalid:ring-3",
