      ...
      >
        {(segment) => (
          <DateSegment
            segment={segment}
            className={twJoin(
              "type-literal:px-0 text-fg data-placeholder:not-data-focused:text-muted-fg inline shrink-0 rounded px-1 tracking-wider caret-transparent outline-0 sm:p-0.5 sm:px-1.5 sm:py-0.5 sm:text-sm",
