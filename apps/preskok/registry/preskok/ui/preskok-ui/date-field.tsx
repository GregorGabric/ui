    ...
    <span data-slot="control" className="relative block">
      <DateInputPrimitive
        className={cx(
          ...
          "group-open:border-ring/70 group-open:bg-primary/5 group-open:ring-ring/20 group-open:enabled:hover:border-ring/80 group-open:ring-3 group-open:outline-hidden",
          "invalid:border-destructive/70 invalid:bg-destructive/0 focus-within:invalid:border-destructive/70 focus-within:invalid:bg-destructive/0 focus-within:invalid:ring-destructive/20 focus-within:invalid:hover:border-destructive/80 invalid:enabled:hover:border-destructive/80",
