...
export default function ExperimentalChartTooltipPreskokDemo() {
  return (
    <Card className="w-full max-w-xl">
      <CardHeader>
        <CardTitle>Tooltip - Default</CardTitle>
        <CardDescription>Default tooltip with chart content.</CardDescription>
      </CardHeader>
      <CardContent>
        <ExperimentalBarChart
          ariaLabel="Tooltip - Default"
          data={chartData}
          dataKey="date"
          type="stacked"
          size={{ height: 250 }}
          ...
          valueAxis={false}
          legend={false}
          tooltipProps={{ defaultIndex: 1, hideLabel: false }}
          config={{
