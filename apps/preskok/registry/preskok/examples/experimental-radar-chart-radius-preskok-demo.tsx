...
export default function ExperimentalRadarChartRadiusPreskokDemo() {
  return (
    <Card className="w-full max-w-md">
      ...
      <CardContent>
        <ExperimentalRadarChart
          ariaLabel="Radar Chart - Radius Axis"
          className="mx-auto"
          data={chartData}
          dataKey="month"
          size={{ height: 250 }}
          grid={{ shape: "circle", valueLabels: "visible" }}
          valueAxis={{ domain: [0, 250] }}
          legend={false}
          config={{
