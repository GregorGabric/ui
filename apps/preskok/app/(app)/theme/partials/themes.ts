...
export const generateTheme = (
  ...
  const lightColors = `--background: ${getColorValue("white")};
    --foreground: ${getColorValue(gray, "950")};
    
    --primary: ${getColorValue(primary, lightPrimary)};
    --primary-foreground: ${lightPrimaryFgValue};
    ...
    --accent-foreground: ${lightAccentFgValue};
  ...
  const darkColors = `--background: ${adjustLightness(getColorValue(gray, "950"), -5)};
    --foreground: ${getColorValue(gray, "50")};
    
    --primary: ${getColorValue(primary, darkPrimary)};
    --primary-foreground: ${darkPrimaryFgValue};
    ...
    --accent-foreground: ${darkAccentFgValue};
